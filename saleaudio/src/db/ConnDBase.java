...
public abstract class ConnDBase implements IConnDBase{
    ...
    */
    ...
    /** TIPO DB 1=Informix, 2=Oracle, 3=Db2, 4=SQL SERVER, 5=Access, 6=Interbase
    */
    private int tipoDB;
    ...
    */
    ...
    /**livello isolamento 1 = UNCOMMITED_READ 2=COMMITED_READ 3=REPEATABLE_READ 4=SERIALIZABLE
    */
    private int il;
	...
	*/
    ...
    {
        if(getDebug())
            System.out.println("ATTIVAZIONE CONNESSIONE " + getAlias() + "[" + getStato() + "]");
        switch(getStato())
        {
        case 3: // '\003'
        default:
        ...
        case 1: // '\001'
            ...
            if(getDebug())
                System.out.println("FALLITA ATTIVAZIONE CONNESSIONE " + getAlias() + "[" + getStato() + "]");
            try
            {
        ...
        case 2: // '\002'
            ...
            catch(Exception e)
            {
                if(getDebug())
                {
                    ...
                    System.out.println("FALLITO TEST CONNESSIONE " + getAlias() + "[" + getStato() + "]");
                }
            }
            setStato(1);
            try
        ...
        case 4: // '\004'
            ...
            {
                if(getDebug())
                    System.out.println("ATTIVA CONNESSIONE " + getAlias() + " Uso connessione secondaria [" + getStato() + "]");
                ((ConnDBase)getConnDBasesecondaria()).attivaConnessione();
                break;
            }
        ...
        case 2: // '\002'
            try
            {
                if(sempreaperta)
                    break;
                if(getDebug())
                    System.out.println("CHIUSURA CONNESSIONE " + getAlias() + "[" + getStato() + "]");
                conn.close();
                setStato(1);
            }
            catch(Exception exception)
    ...
    */
    public final void disposeConnessione()
    {
        ...
        case 2: // '\002'
            ...
            {
                if(getDebug())
                    System.out.println("DISPOSE CONNESSIONE " + getAlias() + "[" + getStato() + "]");
                conn.close();
                setStato(1);
            }
            catch(Exception exception)
